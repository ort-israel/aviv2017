...
and you should find that this lifeneighbor has been added to the list of
installed modules.
...
[![Build Status](https://travis-ci.org/danielneis/moodle-block_lifeneighbor.svg?branch=master)](https://travis-ci.org/danielneis/moodle-block_lifeneighbor)
