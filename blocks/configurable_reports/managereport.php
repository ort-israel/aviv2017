...
if ($reports) {
    ...
    foreach ($reports as $r) {
        ...
        if (isset($components['permissions']['elements'])) {
            $editcell .= '<a title="'.$strpermissions.'" href="editcomp.php?id='.$r->id.'&amp;comp=permissions&amp;sesskey='.$USER->sesskey.'"><img src="'.$OUTPUT->image_url('/i/lock').'" class="iconsmall" alt="'.$strpermissions.'" /></a>&nbsp;&nbsp;';
        }
