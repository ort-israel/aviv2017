...
$PAGE->requires->js('/theme/growth_pedagogy/javascript/toggleabout.js');

//Tsofiya 2018: add scroll to top link
$PAGE->requires->js('/theme/growth_pedagogy/javascript/scrolltotop.js');

// Add coloring of sections in inner pages
$PAGE->requires->js('/theme/growth_pedagogy/javascript/colorsections.js');
