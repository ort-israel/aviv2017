 ...
 */
function theme_growth_pedagogy_css_tree_post_processor($tree, $theme) {
    $prefixer = new theme_growth_pedagogy\autoprefixer($tree);
    $prefixer->prefix();
}
 ...
 * @return string
 */
function theme_growth_pedagogy_get_main_scss_content($theme) {
    global $CFG;

    /* Lea 10/2017 - No more presets. There is only one color scheme for this theme */

    $scss = file_get_contents($CFG->dirroot . '/theme/growth_pedagogy/scss/moodle.scss');
    return $scss;
}
 ...
 * @return array
 */
function theme_growth_pedagogy_get_pre_scss($theme) {
    global $CFG;
 ...
 * @return string
 */
function theme_growth_pedagogy_get_extra_scss($theme) {
