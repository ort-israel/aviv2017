...
//    }
    ...
    public function teacherdash() {
        ...
        $summary = theme_aviv2020_strip_html_tags($COURSE->summary);
        $summarytrim = theme_aviv2020_course_trim_char($summary, 300);
        $courseinfo = array(
            array(
        ...
        return $this->render_from_template('theme_aviv2020/teacherdash', $dashlinks);
    ...
    public function fp_statistics() {
        ...
        /* Get strings*/
        $statisticstitle = get_string('statisticstitle', 'theme_aviv2020');
        $statisticscourses = get_string('courses', 'theme_aviv2020');
        $statisticsteachers = get_string('teachers', 'theme_aviv2020');
        $statisticsstudents = get_string('students', 'theme_aviv2020');
        ...
        return $this->render_from_template('theme_aviv2020/fpstatistics', $fp_statistics);
    }

    /**
     * Put logo in top menu. Called from header.mustache
     * Lea 2017/7. Code taken from earlier function context_header.
     * In order for it to return the file, a condition is added to function theme_aviv2020_pluginfile in theme/aviv2020/lib/filesettings_lib.php
     */
    ...
    public function get_campus_header_title_primary() {
        $theme = theme_config::load('aviv2020');
    ...
    public function footer_details_title() {
        return get_string('contactandsupporttitle', 'theme_aviv2020');
    }
