...
function theme_aviv2020_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options = array()) {
    static $theme;
    if (empty($theme)) {
 ...
 * @return string
 */
function theme_aviv2020_get_setting($setting, $format = false) {
    global $CFG;
