...
class core_renderer extends \core_renderer {
    ...
    public function edit_button(moodle_url $url) {
        ...
        if ($this->page->user_is_editing()) {
            $url->param('edit', 'off');
            $btn = 'btn-danger';
            $title = get_string('editoff', 'theme_aviv2018');
            $icon = 'fa-power-off';
        } else {
            $url->param('edit', 'on');
            $btn = 'btn-success';
            $title = get_string('editon', 'theme_aviv2018');
            $icon = 'fa-edit';
        }
    ...
    protected function render_custom_menu(custom_menu $menu) {
        ...
        if (isloggedin() && !isguestuser() && $hasdisplaymycourses) {
            ...
            if ($mycoursetitle == 'module') {
                $branchtitle = get_string('mymodules', 'theme_aviv2018');
            } else if ($mycoursetitle == 'unit') {
                $branchtitle = get_string('myunits', 'theme_aviv2018');
            } else if ($mycoursetitle == 'class') {
                $branchtitle = get_string('myclasses', 'theme_aviv2018');
            } else {
                $branchtitle = get_string('mycourses', 'theme_aviv2018');
            }
            ...
            if ($courses = enrol_get_my_courses(NULL, 'fullname ASC')) {
                ...
                $noenrolments = get_string('noenrolments', 'theme_aviv2018');
                $branch->add('<em>' . $noenrolments . '</em>', new moodle_url('/'), $noenrolments);
            }
            if (is_siteadmin()) {
                $branchtitle = get_string('siteadminquicklink', 'theme_aviv2018');
                $branchlabel = $branchtitle;
    ...
    protected
    function render_thiscourse_menu(custom_menu $menu) {
        global $CFG;
        ...
        if (isloggedin() && !isguestuser()) {
            if (!empty($PAGE->theme->settings->activitymenu)) {
                if (ISSET($COURSE->id) && $COURSE->id > 1) {
                    $branchtitle = get_string('thiscourse', 'theme_aviv2018');
                    $branchlabel = $branchtitle;
                    ...
                    if (has_capability('enrol/category:config', $context) && $PAGE->theme->settings->userenrollmenu) {
                        $branchtitle = get_string('thiscourseenroll', 'theme_aviv2018');
                        $branchlabel = $branchtitle;
                    ...
                    if (has_capability('moodle/course:managegroups', $context) && $PAGE->theme->settings->groupmanagemenu) {
                        $branchtitle = get_string('thiscoursegroups', 'theme_aviv2018');
                        $branchlabel = $branchtitle;
                    ...
                    if (has_capability('mod/quiz:manage', $context) && $PAGE->theme->settings->questionbankmenu) {
                        $branchtitle = get_string('thiscoursequestion', 'theme_aviv2018');
                        $branchlabel = $branchtitle;
                    ...
                    if (has_capability('mod/quiz:manage', $context) && $PAGE->theme->settings->questioncategorymenu) {
                        $branchtitle = get_string('thiscoursequestioncat', 'theme_aviv2018');
                        $branchlabel = $branchtitle;
                    ...
                    if ($PAGE->theme->settings->activitylistingmenu) {
                        $data = theme_aviv2018_get_course_activities();
     ...
     */
    protected
    function render_tabobject(tabobject $tab) {
     ...
     */
    public
    function body_css_classes(array $additionalclasses = array()) {
     ...
     */
    public
    function render_preferences_groups(preferences_groups $renderable) {
     ...
     */
    public
    function render_action_menu(action_menu $menu) {
     ...
     */
    protected
    function render_help_icon(help_icon $helpicon) {
     ...
     */
    protected
    function render_single_button(single_button $button) {
     ...
     */
    protected
    function render_single_select(single_select $select) {
     ...
     */
    protected
    function render_url_select(url_select $select) {
     ...
     */
    protected
    function render_pix_icon(pix_icon $icon) {
     ...
     */
    public
    function render_login(\core_auth\output\login $form) {
        global $SITE;
     ...
     */
    public
    function render_login_signup_form($form) {
        global $SITE;
     ...
     */
    public
    function context_header_settings_menu() {
        $context = $this->page->context;
     ...
     */
    public
    function region_main_settings_menu() {
        $context = $this->page->context;
        $menu = new action_menu();
     ...
     */
    private
    function build_action_menu_from_navigation(action_menu $menu,
    ...
    function social_icons() {
        ...
        return $this->render_from_template('theme_aviv2018/socialicons', $socialcontext);

    }

    public
    function fp_wonderbox() {
        global $PAGE;
        ...
        $fpsearch = get_string('fpsearch', 'theme_aviv2018');
        $fptextbox = (empty($PAGE->theme->settings->fptextbox && isloggedin())) ? false : format_text($PAGE->theme->settings->fptextbox);
        $footer1 = (empty($PAGE->theme->settings->footer1)) ? false : format_text($PAGE->theme->settings->footer1);
        ...
        return $this->render_from_template('theme_aviv2018/fpwonderbox', $fp_wonderboxcontext);

    }

    public
    function fp_marketingtiles() {
        global $PAGE;
