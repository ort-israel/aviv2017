...
if (theme_aviv2018_get_setting('enablefrontpageavailablecoursebox')) {
class course_renderer extends \core_course_renderer {
    ...
    public function course_search_form($value = '', $format = 'plain') {
        ...
        return $this->render_from_template('theme_aviv2018/course_search_form', $data);
    }
    	...
    	if (count($rcourseids) > 0) {
    		foreach ($acourseids as $courseids) {
    			...
    			foreach ($courseids as $courseid) {
                    ...
                    $trimtitle = theme_aviv2018_course_trim_char($course->fullname, $trimtitlevalue);
        ...
        if (count($rcourseids) > 0) {
            foreach ($acourseids as $courseids) {
                ...
                foreach ($courseids as $courseid) {
                    ...
                    $summary = theme_aviv2018_course_trim_char($summary, $trimsummaryvalue);
     ...
     */
        ...
        // LOAD ICON
        $val = theme_aviv2018_get_setting('catsicon');
