 ...
 */
function theme_aviv2018_css_tree_post_processor($tree, $theme) {
    $prefixer = new theme_aviv2018\autoprefixer($tree);
    $prefixer->prefix();
}
 ...
 * @return array
 */
function theme_aviv2018_get_pre_scss($theme) {
    global $CFG;
 ...
 * @return string
 */
function theme_aviv2018_get_extra_scss($theme) {
