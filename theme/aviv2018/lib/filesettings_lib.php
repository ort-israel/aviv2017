...
function theme_aviv2018_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options = array()) {
    static $theme;
    if (empty($theme)) {
 ...
 * @return string
 */
function theme_aviv2018_get_setting($setting, $format = false) {
    global $CFG;
