...
$page = new admin_settingpage('theme_aviv2018_presets', get_string('presets_settings', 'theme_aviv2018'));

// Preset.
$name = 'theme_aviv2018/preset';
$title = get_string('preset', 'theme_aviv2018');
$description = get_string('preset_desc', 'theme_aviv2018');
$presetchoices[] = '';
...
$fs = get_file_storage();
$files = $fs->get_area_files($context->id, 'theme_aviv2018', 'preset', 0, 'itemid, filepath, filename', false);
...
$name = 'theme_aviv2018/presetfiles';
$title = get_string('presetfiles', 'theme_aviv2018');
$description = get_string('presetfiles_desc', 'theme_aviv2018');
