...
function theme_mop_general_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options = array()) {
    static $theme;
    if (empty($theme)) {
 ...
 * @return string
 */
function theme_mop_general_get_setting($setting, $format = false) {
    global $CFG;
