 ...
 */
function theme_mop_general_css_tree_post_processor($tree, $theme) {
    $prefixer = new theme_mop_general\autoprefixer($tree);
    $prefixer->prefix();
}
 ...
 * @return string
 */
function theme_mop_general_get_main_scss_content($theme) {
    global $CFG;

    /* Lea 10/2017 - No more presets. There is only one color scheme for this theme */

    $scss = file_get_contents($CFG->dirroot . '/theme/mop_general/scss/moodle.scss');
    return $scss;
}
 ...
 * @return array
 */
/*function theme_mop_general_get_pre_scss($theme) {
    global $CFG;
 ...
 * @return string
 */
function theme_mop_general_get_extra_scss($theme) {
