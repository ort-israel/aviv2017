...
$string['pluginname'] = 'Mop General';
// A description shown in the admin theme selector.
$string['choosereadme'] = 'Theme Mop General is a child theme of Fordson. It is customized to ORT ISrael needs.';
$string['configtitle'] = 'Mop General';
