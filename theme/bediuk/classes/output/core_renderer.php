...
//    }
    ...
    public function teacherdash() {
        ...
        $summary = theme_bediuk_strip_html_tags($COURSE->summary);
        $summarytrim = theme_bediuk_course_trim_char($summary, 300);
        $courseinfo = array(
            array(
        ...
        return $this->render_from_template('theme_bediuk/teacherdash', $dashlinks);
    ...
    public function fp_statistics() {
        ...
        /* Get strings*/
        $statisticstitle = get_string('statisticstitle', 'theme_bediuk');
        $statisticscourses = get_string('courses', 'theme_bediuk');
        $statisticsteachers = get_string('teachers', 'theme_bediuk');
        $statisticsstudents = get_string('students', 'theme_bediuk');
        ...
        return $this->render_from_template('theme_bediuk/fpstatistics', $fp_statistics);
    }

    /**
     * Put logo in top menu. Called from header.mustache
     * Lea 2017/7. Code taken from earlier function context_header.
     * In order for it to return the file, a condition is added to function theme_bediuk_pluginfile in theme/bediuk/lib/filesettings_lib.php
     */
    ...
    public function footer_details_title() {
        return get_string('contactandsupporttitle', 'theme_bediuk');
    }
