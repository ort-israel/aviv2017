...
bediuk_boostnavigation_extend_navigation($PAGE->navigation);
bediuk_local_navigation_extend_navigation($PAGE->navigation);
...
echo $OUTPUT->render_from_template('theme_bediuk/frontpage', $templatecontext);